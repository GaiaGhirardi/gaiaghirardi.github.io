...
### Parental separation, child's genotype and family SES (Add Health and HRS data) - _Demography_  

- Socioeconomic status, genotype, and the differential effects of parental separation on educational attainment (w/ Fabrizio Bernardi)  [Replication materials](https://github.com/GaiaGhirardi/parents_separation_genes).

### ECEC (NEPS data) - _Acta Sociologica_ 
